          ...
          {p.plans.map((pl, i) => (
            <div key={i} style={{...s.card,...(pl.pop?s.pop:{})}}>
              ...
              {pl.ent
                ...
                : pl.badge
                  ? <div style={s.freePrice}>{pl.price}<span style={s.freePer}> · {pl.per}</span></div>
              ...
              <a href={pl.ent?'mailto:sales@techbee.ae':'https://webishopi.com'} style={pl.pop?s.btnF:pl.badge?s.btnFree:s.btnO}>
...
const s={
  ...
  freePrice:{fontFamily:"'Sora',sans-serif",fontSize:30,fontWeight:700,color:'#14b8a6',letterSpacing:-1,margin:'18px 0 4px'},
  freePer:{fontSize:14,fontWeight:600,color:'#0d9488'},
